'''
the first program is the FaceDetectModule with fancy draw
bBox is a tuple <class 'tuple'>   ((417, 182), (704, 469))
bboxs.append([id,bBox,score])   output: [[0, ((385, 192), (694, 501)), 91]]
the second works great no fancy draw
'''
...
def main():
    ...
    while True:
        ret,img=cap.read()
        img,bboxs=myFaceDetect.mpFaceProcess(img)
        for i in bboxs:
